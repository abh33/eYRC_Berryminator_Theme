...
def detect_berry_positions(berries_dictionary):
	...
	for berry_type in berries_dictionary.keys():
		...
		for berry in berry_details_list:
			...
			horizontal_displacement = round((0.001953*pixel_x) - 0.4983, 4)
			vertical_displacement = round((0.001953*pixel_y) - 0.4983, 4)
			distance_from_sensor = round((2.008*depth_val) + 0.02532, 4)
			berry_positions_list.append((horizontal_displacement, vertical_displacement, distance_from_sensor))

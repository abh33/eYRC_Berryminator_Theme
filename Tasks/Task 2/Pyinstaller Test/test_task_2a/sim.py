...
def simxGetObjectOrientation_mod_berry(clientID, objectHandle, relativeToObjectHandle, operationMode):
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxGetObjectQuaternion_mod_berry(clientID, objectHandle, relativeToObjectHandle, operationMode):
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxGetObjectPosition_mod_berry(clientID, objectHandle, relativeToObjectHandle, operationMode):
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxSetObjectOrientation_mod_berry(clientID, objectHandle, relativeToObjectHandle, eulerAngles, operationMode):
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxSetObjectQuaternion_mod_berry(clientID, objectHandle, relativeToObjectHandle, quaternion, operationMode):
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxSetObjectPosition_mod_berry(clientID, objectHandle, relativeToObjectHandle, position, operationMode):
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxGetObjectFloatParameter_mod_berry(clientID, objectHandle, parameterID, operationMode):
    return simxGetObjectFloatParam(clientID, objectHandle, parameterID, operationMode)

def simxGetObjectFloatParam_mod_berry(clientID, objectHandle, parameterID, operationMode):
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxSetObjectFloatParameter_mod_berry(clientID, objectHandle, parameterID, parameterValue, operationMode):
    return simxSetObjectFloatParam(clientID, objectHandle, parameterID, parameterValue, operationMode)

def simxSetObjectFloatParam_mod_berry(clientID, objectHandle, parameterID, parameterValue, operationMode):
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxGetObjectIntParameter_mod_berry(clientID, objectHandle, parameterID, operationMode):
    return simxGetObjectInt32Param(clientID, objectHandle, parameterID, operationMode)

def simxGetObjectInt32Param_mod_berry(clientID, objectHandle, parameterID, operationMode):
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxSetObjectIntParameter_mod_berry(clientID, objectHandle, parameterID, parameterValue, operationMode):
    return simxSetObjectInt32Param(clientID, objectHandle, parameterID, parameterValue, operationMode)

def simxSetObjectInt32Param_mod_berry(clientID, objectHandle, parameterID, parameterValue, operationMode):
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxGetObjectGroupData_mod_berry(clientID, objectType, dataType, operationMode):
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''

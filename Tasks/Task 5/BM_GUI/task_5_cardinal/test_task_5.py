...
def send_data_e_yantra_server():
    ...
    while submission_attempts<5:
        ...
        try:
            ...
            # input('\nPress any key to try again.', flush=True)
...
def calculate_score( end_sim_time, ci_list_to_show, pluck_list_to_show, dropped_in_cb1, dropped_in_cb2, total_no_of_collisions):
    ...
    if valid_run_flag:
        ...
        print()
        print("Correctly Identified   :", final_ci_list, flush=True)
        print("Correctly Plucked      :", final_cp_list, flush=True)
        print("Correctly Dropped      :", final_cd_list, flush=True)

        print()
        # print("Total Simulation Time  :", T, flush=True)
        # print("CI                     :", CI, flush=True)
        # print("CP                     :", CP, flush=True)
        # print("CD                     :", CD, flush=True)
        # print("P                      :", P, flush=True)
        # print("B                      :", B, flush=True)
        # print("Task 5 Score           :", score, flush=True)
    ...
    try:
        ...
        if (client_id != -1):
            ...
            try:
                ...
                print('\n[ERROR] Test script for Task 5 interrupted by user!', flush=True)
                #end_program()			
...
try:
    if __name__ == '__main__':
        ...
        if conda_env_name_flag == 1:
            ...
            # input("\nPress ENTER to start Task 5 evaluation  ", flush=True)
            print()
            ...
            if(return_value==1):
                ...
                print('FALIED generating theme_implementation_result.txt. Please try again.', flush=True)

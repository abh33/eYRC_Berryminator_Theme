...
def theme_implementation_primary( client_id, rooms_entry):
    ...
    # cheat_code(client_id, "Lemon", "lemon_1#0", "force_sensor_l1#0", "collection_box_2")
    # cheat_code(client_id, "Lemon", "lemon_2#0", "force_sensor_l2#0", "collection_box_2")
    # cheat_code(client_id, "Lemon", "lemon_1#1", "force_sensor_l1#1", "collection_box_2")
    ...
    cheat_code(client_id, "Blueberry", "blueberry_1", "force_sensor_b1", "collection_box_2")
    cheat_code(client_id, "Blueberry", "blueberry_2", "force_sensor_b2", "collection_box_2")
    cheat_code(client_id, "Blueberry", "blueberry_1#0", "force_sensor_b1#0", "collection_box_2")
    cheat_code(client_id, "Blueberry", "blueberry_2#0", "force_sensor_b2#0", "collection_box_2")
    cheat_code(client_id, "Blueberry", "blueberry_1#1", "force_sensor_b1#1", "collection_box_2")

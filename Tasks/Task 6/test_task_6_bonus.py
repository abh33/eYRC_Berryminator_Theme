...
*        =================================================
*                                                         
*  This script is intended to check the output of Task 6 Bonus Configuration        
...
def send_data_e_yantra_server():
    ...
    while submission_attempts<5:
        ...
        try:
            ...
            g_sheet=service_acc.open('Bonus_Real_Time_Performance_of_Teams_in_Task_6')
    ...
    try:
        ...
        if (client_id != -1):
            ...
            try:
                ...
                print('\n[ERROR] Test script for Task 6 interrupted by user!')
                #end_program()			
    ...
    if __name__ == '__main__':
        ...
        if conda_env_name_flag == 1:
            ...
            if(return_value==1):
                ...
                print('\nFAILED generating theme_implementation_result.txt. Please try again.')

...
# Functions:		[ init_remote_api_server, start_simulation, stop_simulation, exit_remote_api_server, adjust_position, nav_to_room, rotate_bot_right, rotate_bot_left, nav_outof_room, reach_cb, theme_implementation_primary]
# Global variables:	
...
def nav_to_room(client_id, rooms_entry, index, Berry_count):
	...
	if(room_entry in [(0,5), (2,5), (0,3), (2,3)]):			# if entry is in [(0,5),(2,5),(0,3),(2,3)]
	...
	if(room_entry in [(6,5), (8,5), (6,3), (8,3)]):			# if entry is in [(6,5),(8,5),(6,3),(8,3)]
	...
	if(room_entry in [(3,6), (3,8), (5,6), (5,8)]):			# if entry is in [(3,6),(3,8),(5,6),(5,8)]
	...
	if(room_entry in [(3,0), (5,0), (3,2), (5,2)]):			# if entry is in [(3,0),(5,0),(3,2),(5,2)]
...
def nav_outof_room(client_id, rooms_entry, index, Berry_count):
	...
	if(room_entry in [(0,5), (2,5), (2,3)]):			# if entry is in [(0,5),(2,5),(0,3),(2,3)]
	...
	if(room_entry in [(6,5), (6,3), (8,3)]):			# if entry is in [(6,5),(8,5),(6,3),(8,3)]
	...
	if(room_entry in [(3,6),(5,6),(5,8)]):			# if entry is in [(3,6),(3,8),(5,6),(5,8)]
		...
		if(room_entry in [(3,6)]):
			...
			task_3.task_3_primary(client_id, [room_entry, (4,7)]) # change in task 3
	...
	if(room_entry in [(3,0), (3,2), (5,2)]):			# if entry is in [(3,0),(5,0),(3,2),(5,2)]
...
def theme_implementation_primary( client_id, rooms_entry):
	...
	sim.simxSetJointTargetPosition(client_id,joint_handle1,0*math.pi/180,sim.simx_opmode_oneshot)
	sim.simxSetJointTargetPosition(client_id,joint_handle2,-20*math.pi/180,sim.simx_opmode_oneshot)
	sim.simxSetJointTargetPosition(client_id,joint_handle3,20*math.pi/180,sim.simx_opmode_oneshot)

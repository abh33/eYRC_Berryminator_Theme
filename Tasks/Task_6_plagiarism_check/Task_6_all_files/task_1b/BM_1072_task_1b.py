...
def get_vision_sensor_image(client_id,objhandle):
	...
	##############	ADD YOUR CODE HERE	##############
	return_code, image_resolution, vision_sensor_image= sim.simxGetVisionSensorImage(client_id, objhandle, 0, sim.simx_opmode_blocking)
...
def detect_qr_codes(transformed_image):
	...
	for code in detected_codes:
		...
		y=code.rect[2]-code.rect[3]/2
		qr_codes.append([code.data.decode("utf-8"), (x, y)])
	return qr_codes

...
# Team ID:			[ 1115 ]
# Author List:		[ Nisarga,Ramya,Rohith,Rabbi ]
# Filename:			task_1b.py
...
def get_vision_sensor_image(client_id):
	...
	##############	ADD YOUR CODE HERE	##############
	res,vision_sensor_handle=sim.simxGetObjectHandle(client_id,'vision_sensor',sim.simx_opmode_oneshot_wait)
...
def transform_vision_sensor_image(vision_sensor_image, image_resolution):
	...
	##############	ADD YOUR CODE HERE	##############
	#print("inside task 1b=" transformed_image)
	...
	#transformed_image = cv2.flip(rgb, 0)
...
def detect_qr_codes(transformed_image):
	...
	for code in result:
		...
		x,y,w,h=code.rect
		qr_codes.append([codeData,((x+w)/2,(y+h)/2)])

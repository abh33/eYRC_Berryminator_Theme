...
def nav_logic(client_id, wheel_joints, path):
	...
	speed = 20	 # The speed at which the bot travels in the direction of motion
		...
		if mode == 1:
			...
			if qr_codes_data:
				...
				if (direction == "left" or direction == "right"): 
					# Errors change for every aisle to avoid wall-crash
			...
			#Harcoding errors to avoid wall-crashes
